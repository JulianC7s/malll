...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-11-2020 a las 03:33:25
...
--
-- Base de datos: `basedatoscitas2020`
--
...
CREATE TABLE `medicos` (
  `MedIdentificacion` varchar(50) NOT NULL,
...
ALTER TABLE `citas`
  ...
  ADD KEY `citas_ibfk_1` (`CitPaciente`),
  ADD KEY `citas_ibfk_2` (`CitMedico`),
  ADD KEY `citas_ibfk_3` (`CitConsultorio`);
...
ALTER TABLE `tratamientos`
  ...
  ADD KEY `Tratamientos_ibfk_1` (`TraPaciente`);
